...
public class TelaCadastroClientes01 extends javax.swing.JFrame {
    public TelaCadastroClientes01() {
...
if(evt.getSource() == pesquisar){
    ...
    try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroClientes01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaCadastroClientes01 tc = new TelaCadastroClientes01();
                tc.setVisible(true);
            }
        });
    }
